if getSystemArchitecture()>=2 then return end --arm+ not supported yet

if getOperatingSystem()~=0 then return end --not windows
...
scripts['2 Bytes B/E'].type=registerCustomTypeAutoAssembler([[
alloc(TypeName,256)
alloc(ByteSize,4)
...
local function registerBigEndianInt24()
scripts['3 Bytes B/E'].type=registerCustomTypeAutoAssembler([[
alloc(TypeName,256)
alloc(ByteSize,4)
alloc(ConvertRoutine,1024)
alloc(ConvertBackRoutine,1024)
...
scripts['4 Bytes B/E'].type=registerCustomTypeAutoAssembler([[
alloc(TypeName,256)
alloc(ByteSize,4)
alloc(ConvertRoutine,1024)
alloc(ConvertBackRoutine,1024)
...
scripts['Float B/E'].type=registerCustomTypeAutoAssembler([[
alloc(TypeName,256)
alloc(ByteSize,4)
alloc(ConvertRoutine,1024)
alloc(ConvertBackRoutine,1024)
...
scripts['2 Bytes B/E']={func=registerBigEndianInt16,reg='EnableBigEndianInt16'}
scripts['3 Bytes B/E']={func=registerBigEndianInt24,reg='EnableBigEndianInt24'}
scripts['4 Bytes B/E']={func=registerBigEndianInt32,reg='EnableBigEndianInt32'}
scripts['Float B/E']={func=registerBigEndianFloat,reg='EnableBigEndianFloat'}
local scriptnames={
  '2 Bytes B/E',
  '3 Bytes B/E',
  '4 Bytes B/E',
